...
public class Patient_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(T1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 340, 300, 30));
        ...
        getContentPane().add(P1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 380, 300, 30));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/HMS_Package/Images/PatientLoginForm1.png"))); // NOI18N
        jLabel3.setBorder(javax.swing.BorderFactory.createEmptyBorder(30, 30, 30, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       String sql = "SELECT * FROM `patient` WHERE `p_id`='"+p_id+"' and `password`='"+pass+"'";
